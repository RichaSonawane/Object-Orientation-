...
/*
  After you've made your object, use bracket or dot notation to add another key named 'car' with the value being your favorite 
  car and then another key named 'show' with the value being your favorite show.
*/

//Code here
favoriteThings.car = "Honda";
favoriteThings.show = "Crown";
...
let total = totalPopulation(population);
console.log(total);
...
class Wizard {
  ...
  castSpell() {
    let spell1 = `${this.name} has cast ${this.favoriteSpell}`;
    return spell1;
  }
}
let myWizard = new Wizard("Richa", 34, "swaha");
...
//Code Here
let iphone = new Phone("Apple", "14", 100, "white", 1000);
let samsung = new Phone("Samsung", "S20", 200, "red", 2000);
let motorola = new Phone("Motorola", "M30", 300, "black", 3000);
...
*/
const myFirstVehicle= new Vehicle(100,"White",60);
...
//Code Here
const myFirstMotorcycle= new Motorcycle(200,"red",30,2022,true);
...
//Code Here
const myFirstBoat= new Boat(500,"yellow",70,"Sea Beast","powerboat",false);
/*
